...
Colors are dynamically generated by **Noctalia** theme engine and change with your wallpaper.  
The palette below is an example — actual colors update on the fly.
