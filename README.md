...
<p align="center">
  <b>✦ Noctalia-themed Hyprland Lua configuration for Arch Linux ✦</b>
</p>
...
└── .config/
    ...
    │   ├── noctalia.lua  # Theme integration
...
| Color | Hex | Usage |
|---|---|---|
| ![#eebe8a](https://placehold.co/15x15/eebe8a/eebe8a.png) | `#eebe8a` | Primary accent |
| ![#dcc2a9](https://placehold.co/15x15/dcc2a9/dcc2a9.png) | `#dcc2a9` | Secondary accent |
| ![#16130f](https://placehold.co/15x15/16130f/16130f.png) | `#16130f` | Surface |
| ![#ffb4ab](https://placehold.co/15x15/ffb4ab/ffb4ab.png) | `#ffb4ab` | Error / Warning |

<br>

### ✦ Acknowledgements

- **[Noctalia](https://github.com/noctalia)** — theme engine used across the config
